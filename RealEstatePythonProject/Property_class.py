# Author: Agnes Fusese
# It will be the Parent file for the Lands and House class and contains all the Parents arguments to passed.
class Property:
    ...
    def property_info(self,PropertyLocation,RentOutTimes,price):
